vehiculos_star_wars = ['X-wing', 'TIE fighter', 'Millennium Falcon', 'Star Destroyer', 'AT-AT', 'Imperial Shuttle', 'A-wing', 'B-wing', 'T-47 Airspeeder',                      'Landspeeder', 'Speeder bike', 'Jedi Starfighter', 'Naboo Starfighter',                       'Podracer', 'Hutt Barge', 'Jawa Sandcrawler', 'Tantive IV', 'Cloud Car',                      'Snowspeeder', 'Z-95 Headhunter', 'Y-wing', 'ARC-170', 'LAAT/i Gunship',                       'Imperial Troop Transport', 'Coruscant Air Taxi', 'Bongo Submarine',                       'Gungan Bongo', 'Vulture Droid', 'STAP']
"""
